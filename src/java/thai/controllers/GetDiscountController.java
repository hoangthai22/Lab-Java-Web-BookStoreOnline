 ...
 * @author ASUS
 */
@WebServlet(urlPatterns = {"/GetDiscountController"})
public class GetDiscountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<DiscountObj> listDiscount = dao.getDiscountByUser(user.getUserID());
            request.setAttribute("listDiscount", listDiscount);
            url = MY_DISCOUNT_PAGE;
        } catch (Exception e) {
            LOGGER.info("ERROR at GetDiscountContoller:" + e.getMessage());
            e.printStackTrace();
        } finally {
