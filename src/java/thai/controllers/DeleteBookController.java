...
public class DeleteBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookDao.UpdateStatusBook(id, status)) {
                request.setAttribute("deleteSuccess", "Successfully deleted " + name + " book ");
            } 
            url = HOME;
        } catch (Exception e) {
            LOGGER.info("ERROR at DeleteBookController:" + e.getMessage());
        } finally {
