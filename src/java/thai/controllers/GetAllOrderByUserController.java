 ...
 * @author ASUS
 */
@WebServlet(name = "GetAllOrderByUserController", urlPatterns = {"/GetAllOrderByUserController"})
public class GetAllOrderByUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(user != null){
                ...
                List<OrderObj> listOrder = dao.getAllOrderByUser(user.getUserID()); 
                request.setAttribute("listOrder", listOrder);
                url = ORDER_HISTORY_PAGE;
            }
            
        } catch (Exception e) {
            LOGGER.info("ERROR at GetAllOrderByUserController:" + e.getMessage());
        } finally {
